"""
Django settings for SongScripts project.
...
SECRET_KEY = 'django-insecure-%iv5e2flj%6=ftu-!!est)e8b-moct6075aoa5_e+)1mm@^l4n'
...
WSGI_APPLICATION = 'SongScripts.wsgi.application'
